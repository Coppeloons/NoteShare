...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChainForApi(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .requestMatchers(HttpMethod.GET, "/api/noteHub").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/noteHub").authenticated()
    ...
    public SecurityFilterChain filterChainForWeb(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .requestMatchers(HttpMethod.GET, "/noteHub/**").permitAll()
